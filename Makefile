...
SRC= parser/expand.c parser/handle_quotes.c parse_v2/check_opers.c parse_v2/split_input.c parse_v2/expanding.c parse_v2/get_tokens.c libft/ft_substr.c libft/ft_strdup.c libft/ft_strlen.c libft/ft_calloc.c libft/ft_bzero.c libft/ft_memset.c \
	 libft/ft_strjoin.c libft/ft_strnstr.c libft/ft_strlcat.c libft/ft_strlcpy.c libft/ft_split.c libft/ft_strchr.c libft/ft_isalnum.c libft/ft_itoa.c libft/ft_isdigit.c
OBJ= $(SRC:.c=.o)
