...
SRC= parser/expand.c parser/handle_quotes.c parse_v2/parse.c parse_v2/parse_utils.c parse_v2/check_opers.c parse_v2/split_input.c parse_v2/expanding.c parse_v2/get_tokens.c libft/ft_substr.c libft/ft_strdup.c libft/ft_strlen.c libft/ft_calloc.c libft/ft_bzero.c libft/ft_memset.c \
